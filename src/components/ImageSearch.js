...
const ImageSearch = ({searchText}) => {
  ...
  return (
      ...
      <div className='max-w-sm rounded overflow-hidden my-10 mx-auto border-2 border-purple-700'>
        <form onSubmit={onsubmit} className="w-full max-w-sm">
          <div className="flex items-center border-b-4 border-teal-500 py-2">
